...
describe Book do
    before(:all) do
        @book = Book.new('publisher', 'bad', '2020-01-01')
    end
    ...
    describe '#to_json' do
        it 'should return a json representation of the book' do
            expect(@book.to_json).to eq("{\"id\":\"#{@book.id}\",\"publish_date\":\"2020-01-01\",\"archived\":false,\"publisher\":\"publisher\",\"cover_state\":\"bad\",\"label_id\":null}")
        end
    end
